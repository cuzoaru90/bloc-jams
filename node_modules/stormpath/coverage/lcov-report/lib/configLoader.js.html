...
<span class="fstat-no" title="function not covered" >function ClientFactory (config) {</span>
<span class="cstat-no" title="statement not covered" >  return new Client(</span>
