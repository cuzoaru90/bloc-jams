...
<span class="cstat-no" title="statement not covered" >      return Object.keys(self.caches).reduce(<span class="fstat-no" title="function not covered" >function(a,region){</span></span>
<span class="cstat-no" title="statement not covered" >        a[region] = self.caches[region].stats;</span>
