  ...
  <div class='pad1'>
    ...
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>131/194</span>
      </div>
      <div class='fl pad1y space-right2'>
        <span class="strong">45.33% </span>
        <span class="quiet">Branches</span>
        <span class='fraction'>34/75</span>
      </div>
      <div class='fl pad1y space-right2'>
...
622
623
624</td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cstat-no" title="statement not covered" >        awaitReadyProxy.detach(new Error('Stormpath client initialization failed. See error log for more details.'));</span>
      } else {
...
&nbsp;
  ...
  if (args.length === 2 &amp;&amp; args[0] === 'ready' &amp;&amp; _.isFunction(args[1])) {
    var callback = args[1];
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this._isReady) {
 ...
 *  response.
 */
Client.prototype.createResource = <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >  this._dataStore.createResource.apply(this._dataStore, arguments);</span>
};
&nbsp;
/**
...
<span class="cstat-no" title="statement not covered" >  var apps = args.shift();</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    async.map(apps, <span class="fstat-no" title="function not covered" >function(app, cb) {</span></span>
<span class="cstat-no" title="statement not covered" >      return tenant.createApplication(app, options, cb);</span>
    }, <span class="fstat-no" title="function not covered" >function(err, applications) {</span>
<span class="cstat-no" title="statement not covered" >      return callback(err, applications);</span>
    });
  });
};
&nbsp;
 ...
 *  response.
 */
Client.prototype.getAccounts = <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >  var args = Array.prototype.slice.call(arguments);</span>
<span class="cstat-no" title="statement not covered" >  var callback = args.pop();</span>
<span class="cstat-no" title="statement not covered" >  var options = (args.length &gt; 0) ? args.shift() : null;</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    return tenant.getAccounts(options, callback);</span>
  });
};
&nbsp;
/**
 ...
 *  response.
 */
Client.prototype.getGroups = <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >  var args = Array.prototype.slice.call(arguments);</span>
<span class="cstat-no" title="statement not covered" >  var callback = args.pop();</span>
<span class="cstat-no" title="statement not covered" >  var options = (args.length &gt; 0) ? args.shift() : null;</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    return tenant.getGroups(options, callback);</span>
  });
};
&nbsp;
/**
 ...
 *  response.
 */
Client.prototype.getDirectories = <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >  var args = Array.prototype.slice.call(arguments);</span>
<span class="cstat-no" title="statement not covered" >  var callback = args.pop();</span>
<span class="cstat-no" title="statement not covered" >  var options = (args.length &gt; 0) ? args.shift() : null;</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    return tenant.getDirectories(options, callback);</span>
  });
};
&nbsp;
/**
...
<span class="cstat-no" title="statement not covered" >  var args = Array.prototype.slice.call(arguments);</span>
<span class="cstat-no" title="statement not covered" >  var dirs = args.shift();</span>
<span class="cstat-no" title="statement not covered" >  var callback = args.pop();</span>
<span class="cstat-no" title="statement not covered" >  var options = (args.length &gt; 0) ? args.shift() : null;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  this.getCurrentTenant(<span class="fstat-no" title="function not covered" >function(err, tenant) {</span></span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    async.map(dirs, <span class="fstat-no" title="function not covered" >function(dir, cb) {</span></span>
<span class="cstat-no" title="statement not covered" >      return tenant.createDirectory(dir, options, cb);</span>
    }, <span class="fstat-no" title="function not covered" >function(err, directories) {</span>
<span class="cstat-no" title="statement not covered" >      return callback(err, directories);</span>
    });
  });
};
&nbsp;
 ...
 *  response.
 */
Client.prototype.getApplication = <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >  var args = Array.prototype.slice.call(arguments);</span>
<span class="cstat-no" title="statement not covered" >  var href = args.shift();</span>
<span class="cstat-no" title="statement not covered" >  var callback = args.pop();</span>
<span class="cstat-no" title="statement not covered" >  var options = (args.length &gt; 0) ? args.shift() : null;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  return this.getResource(href, options, require('./resource/Application'), callback);</span>
};
&nbsp;
/**
...
Client.prototype.getDirectory = function() {
  ...
  var href = args.shift();
  var callback = args.pop();
  var options = (args.length &gt; 0) ? args.shift() : <span class="branch-1 cbranch-no" title="branch not covered" >null;</span>
&nbsp;
 ...
 *  response.
 */
Client.prototype.getGroupMembership = <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >  var args = Array.prototype.slice.call(arguments);</span>
<span class="cstat-no" title="statement not covered" >  var href = args.shift();</span>
<span class="cstat-no" title="statement not covered" >  var callback = args.pop();</span>
<span class="cstat-no" title="statement not covered" >  var options = (args.length &gt; 0) ? args.shift() : null;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  return this.getResource(href, options, require('./resource/GroupMembership'), callback);</span>
};
&nbsp;
