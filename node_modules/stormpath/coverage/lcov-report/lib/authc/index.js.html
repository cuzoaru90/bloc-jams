...
<span class="cstat-no" title="statement not covered" >    throw new Error('If you do not specify a \'requestAuthenticator\' field, you must specify an ApiKey.');</span>
  }
&nbsp;
...
&nbsp;
    ...
    } else <span class="missing-if-branch" title="else path not taken" >E</span>if (scheme === 'BASIC') {
      authc = new BasicRequestAuthenticator(apiKey);
    } else {
<span class="cstat-no" title="statement not covered" >      throw new Error("Unrecognized authentication scheme: " + options.authenticationScheme);</span>
    }
  }
&nbsp;
  return authc;
